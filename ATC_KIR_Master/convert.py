...
if __name__ == '__main__':
    ...
    parser.add_argument("-i", "--input_model", default="D:/Download/uie_pytorch-main/uie-m-large", type=str,
                        help="Directory of input paddle model.\n Will auto download model [uie-base/uie-tiny]")
    parser.add_argument("-o", "--output_model", default="D:/Download/uie_pytorch-main/uie-m-large-pytorch", type=str,
